...
namespace bind
{
  ...
  public:
    ...
    void operator()(ast::Ast& ast) override;
    ...
    // FIXME: Some code was deleted here.
    /// Report Break error
    void break_error(ast::BreakExp& e);
  ...
  protected:
    ...
    misc::scoped_map<misc::symbol, ast::FunctionDec*> fun_scoped_ =
      misc::scoped_map<misc::symbol, ast::FunctionDec*>();

    misc::scoped_map<misc::symbol, ast::VarDec*> var_scoped_ =
      misc::scoped_map<misc::symbol, ast::VarDec*>();

    misc::scoped_map<misc::symbol, ast::TypeDec*> ty_scoped_ =
      misc::scoped_map<misc::symbol, ast::TypeDec*>();

    std::vector<ast::Exp*> loop_vec = std::vector<ast::Exp*>();
  };
