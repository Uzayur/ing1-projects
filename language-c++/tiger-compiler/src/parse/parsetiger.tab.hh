  ...
  public:
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_exps = 57,           // exps
        S_exp_bracket = 58,    // exp_bracket
        S_exp_opt = 59,        // exp_opt
        S_exp = 60,            // exp
        S_lvalue_bracket = 61, // lvalue_bracket
        S_lvalue_opt = 62,     // lvalue_opt
        S_lvalue = 63,         // lvalue
        S_type_bracket = 64,   // type_bracket
        S_type_opt = 65,       // type_opt
        S_id_bracket = 66,     // id_bracket
        S_id_opt = 67,         // id_opt
        S_chunks = 68,         // chunks
        S_funchunk = 69,       // funchunk
        S_varchunk = 70,       // varchunk
        S_fundec = 71,         // fundec
        S_fun_opt = 72,        // fun_opt
        S_vardec = 73,         // vardec
