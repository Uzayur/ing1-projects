...
{
    struct complex div;
    div.real = a.real * b.real + a.img * b.img;
    div.img = a.img * b.real - a.real * b.img;

    div.real = div.real / (b.real * b.real + b.img * b.img);
    div.img = div.img / (b.real * b.real + b.img * b.img);
    return div;
}
